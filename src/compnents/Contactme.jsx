...
const Contactme = () => {
    const handleWhatsAppRedirect = () => {
        window.location.href = 'https://wa.link/8tge9v';
    };
        ...
        <>
            <label className="popup z-10">
                ...
                <div tabIndex={0} className="burger">
                    ...
                    >
                        <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0-10c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6 2.69-6 6-6zm0 10c-4.41 0-8 3.59-8 8v1h16v-1c0-4.41-3.59-8-8-8z" />
                    </svg>
                </div>
